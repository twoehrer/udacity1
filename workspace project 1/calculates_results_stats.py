...
def calculates_results_stats(results_dic):
    ...
    for results_list in results_dic.values():
        dog_amount += results_list[3]
        matches += results_list[2]
        if results_list[3] == 1: #is really a dog
                correct_dogs += results_list[4]
                correct_breed += results_list[2]
        else: #is really not a dog
                correct_notdogs += 1-results_list[4]

        
    
    results_stats_dic['n_dogs_img'] = dog_amount ## number of dog images
    results_stats_dic['n_notdogs_img'] = results_stats_dic['n_images'] - dog_amount
